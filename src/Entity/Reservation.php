...
class Reservation
{
    ...
    #[ORM\PrePersist]
    public function prePersistSetCreatedAt(): void { $this->createdAt = new \DateTimeImmutable(); }

    public function getId(): ?int { return $this->id; }
    public function getSlot(): ?Slot { return $this->slot; }
    public function setSlot(?Slot $s): self { $this->slot = $s; return $this; }
    ...
    public function setJustification(?string $j): self { $this->justification = $j; return $this; }
